...
export var RightSidebar = function RightSidebar(_ref) {
  var children = _ref.children,
      ...
      height = _ref.height,
      rightSidebarOnLeft = _ref.rightSidebarOnLeft;
  ...
  return React.createElement(Container, {
    ...
    className: "sliderdiv ".concat(expanded ? "expanded" : "")
  }, React.createElement(InnerSliderContent, null, children)), React.createElement(Expander, {
  ...
  }, expanded && !rightSidebarOnLeft || rightSidebarOnLeft && !expanded ? React.createElement(ContractIcon, {
    className: "icon"
