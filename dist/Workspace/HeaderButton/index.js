...
export var HeaderButton = function HeaderButton(_ref2) {
  ...
  return React.createElement(StyledButton, {
    onClick: onClick,
    disabled: disabled
  }, React.createElement(ButtonInnerContent, null, React.createElement(IconContainer, {
    textHidden: hideText
  }, icon || getIcon(name, customIconMapping)), !hideText && React.createElement(Text, null, React.createElement("div", null, name))));
};
